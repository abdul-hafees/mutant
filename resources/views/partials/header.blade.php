<div id="header">
    ...
    ================ -->
    <div id="logo">
        <a href="index.html"><img src="{{asset('frontend/img/logo-dark.png')}}" title="Home" alt="logo"></a>
    </div>
    <!-- End logo -->
    ...
    * Use class "slide-left", "slide-left-half", "slide-right", "slide-right-half", "slide-top", "slide-bottom" or "zoom-in" to change menu effect.
    ...
    <nav id="menu" class="menu slide-right-half bg-image"
         style="background-image: url(/public/frontend/img/misc/menu-bg-1.jpg); background-position: 50% 50%">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="social-buttons">
                            <ul>
                                ...
                                <li><a href="#" class="btn btn-primary btn-link" target="_blank"
                                       title="Follow us on dribbble"><i class="fab fa-dribbble"></i></a></li>
                                <li><a href="#" class="btn btn-primary btn-link" target="_blank"
                                       title="Follow us on behance"><i class="fab fa-behance"></i></a></li>
                                <li><a href="#" class="btn btn-primary btn-link" target="_blank"
                                       title="Follow us on linkedin"><i class="fab fa-linkedin-in"></i></a></li>
                                <li><a href="#" class="btn btn-primary btn-link" target="_blank"
