...
@section('content')
    <div class="panel">
        <form id="form-role-create" method="POST" action="{{ route('admin.roles.store') }}">
            @csrf
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <button id="btn-submit" type="submit" class="btn btn-primary ladda-button" data-style="zoom-in">
                            <span class="ladda-label">Create Role</span>
                        </button>
