...
@section('header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            {{ $category->parent_id ? route('admin.categories.show', $category->parent_id) : route('admin.categories.index') }}">Categories</a></li>
            <li class="breadcrumb-item active" aria-current="page">Subcategories</li>
        </ol>
    </nav>

    <h1 class="page-title">{{ $category->name }} - SubCategories</h1>
        <div class="page-header-actions">
            <a class="btn btn-sm btn-primary " href="{{ route('admin.categories.subcategories.create', $category->id) }}">
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {!! $html->table(['id' => 'tbl-categories'], true) !!}
        </div>
    </div>
@endsection
