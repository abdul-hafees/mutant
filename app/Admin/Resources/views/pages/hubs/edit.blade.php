                    ...
                    <div class="col-7">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group row">
                                    <label for="address"
                                           class="col-md-3 col-form-label">Address
                                        <span class="required">*</span> </label>
                                    <div class="col-md-9">
                                        <textarea  id="address"
                                                   name="address"
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group row">
                                    <label for="pincode"
                                           class="col-md-3 col-form-label">Pincode
                                        <span class="required">*</span> </label>
                                    <div class="col-md-9">
                                        <input id="pincode" name="pincode" type="text"
                                               class="form-control
                                                @error('pincode') is-invalid @enderror"
                                               value="{{ old('pincode', $hub->pincode) }}"
                                               autocomplete="off">
                                        @error('pincode')
                                        <span class="invalid-feedback"
                                              role="alert">{{ $message }}</span>
...
{{--                                <div class="form-group row">--}}
{{--                                    <label for="latitude"--}}
{{--                                           class="col-md-3 col-form-label">Latitude--}}
{{--                                        <span class="required">*</span> </label>--}}
{{--                                    <div class="col-md-9">--}}
{{--                                        <input id="latitude" name="latitude" type="text"--}}
{{--                                               class="form-control--}}
{{--                                               @error('latitude') is-invalid @enderror"--}}
{{--                                               value="{{ old('latitude', $hub->latitude) }}"--}}
{{--                                               autocomplete="off">--}}
{{--                                        @error('latitude')--}}
{{--                                        <span class="invalid-feedback"--}}
{{--                                              role="alert">{{ $message }}</span>--}}
...
{{--                                <div class="form-group row">--}}
{{--                                    <label for="longitude"--}}
{{--                                           class="col-md-3 col-form-label">Longitude--}}
{{--                                        <span class="required">*</span> </label>--}}
{{--                                    <div class="col-md-9">--}}
{{--                                        <input id="longitude" name="longitude" type="text"--}}
{{--                                               class="form-control @error('longitude')--}}
{{--                                                is-invalid @enderror"--}}
{{--                                               value="{{ old('longitude', $hub->longitude)}}"--}}
{{--                                               autocomplete="off">--}}
{{--                                        @error('longitude')--}}
{{--                                        <span class="invalid-feedback"--}}
{{--                                              role="alert">{{ $message }}</span>--}}
