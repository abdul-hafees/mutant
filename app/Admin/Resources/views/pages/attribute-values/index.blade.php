...
@section('header')
    <h1 class="page-title">AttributeValues</h1>
        <div class="page-header-actions">
            <a class="btn btn-sm btn-primary " href="{{ route('admin.attribute-values.create') }}">
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {!! $html->table(['id' => 'tbl-attributevalues'], true) !!}
        </div>
    </div>
@endsection
